<div class="mdl-layout__drawer">
	...
	<nav class="mdl-navigation">
		...
		<a class="mdl-navigation__link" href="/all-groups/"><i class="material-icons">group</i>&nbsp;&nbsp;&nbsp;Groups</a>
		<a class="mdl-navigation__link" href="/services/"><i class="material-icons">account_balance</i>&nbsp;&nbsp;&nbsp;Services</a>
		<a class="mdl-navigation__link" href="/guides/"><i class="material-icons">import_contacts</i>&nbsp;&nbsp;&nbsp;Guides</a>
		<a class="mdl-navigation__link" href="/directory"><i class="material-icons">recent_actors</i>&nbsp;&nbsp;&nbsp;411</a>
		...
		<a class="mdl-navigation__link" href="<?php echo get_ivoice_member_url('activity'); ?>"><i class="material-icons">public</i>&nbsp;&nbsp;&nbsp;Activity</a>
		<div class="insidevoice-drawer-separator"></div>
		<a class="mdl-navigation__link" href="/my-places/"><i class="material-icons">place</i>&nbsp;&nbsp;&nbsp;My Places</a>
